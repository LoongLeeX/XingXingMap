  ...
  const runDiagnostics = async () => {
    const results: any = {
      ...
      env: {
        ...
        apiKeyValue: process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY?.substring(0, 20) + '...' || '',
        mapIdConfigured: !!process.env.NEXT_PUBLIC_GOOGLE_MAPS_MAP_ID,
        mapIdValue: process.env.NEXT_PUBLIC_GOOGLE_MAPS_MAP_ID || '',
      },
      dom: {
